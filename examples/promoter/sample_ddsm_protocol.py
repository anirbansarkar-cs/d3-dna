...
Usage (DDSM):
    python sample_ddsm_protocol.py --model ddsm \
        ...
        --ddsm-schedule ddsm_ref/steps400.cat4.speed_balance.time4.0.samples100000.pth
"""
...
def main():
    ...
    p.add_argument("--ddsm-schedule",
                   default="ddsm_ref/steps400.cat4.speed_balance.time4.0.samples100000.pth",
                   help="(ddsm only) pre-sampled noise schedule")
