...
#SBATCH --job-name=tran_full_fp16
#SBATCH --output=examples/promoter/sample_full_tran_fp16_%j.log
...
OUTDIR=examples/promoter/final_eval/tran_epoch50_full_hybrid_fp16_5x
CKPT=/grid/koo/home/shared/d3/trained_weights/promoter/tran/checkpoint_50.pth

echo "=== Sampling (full test set, 5-per-TSS, hybrid shim, fp16 score_fn) ==="
